...
'//::::::::::::::::::::::::::::::::::    VARIABLES      ::::::::::::::::::::::::::::::::::
    Private cTest   As C_TestBarre      '// Classe qui utilise les contrôles labels.
    Private cBarre  As C_LabelsInfo     '// Classe C_LabelsInfo utiliser par cTest
'//:::::::::::::::::::::::::::::::::: END VARIABLES ::::::::::::::::::::::::::::::::::::::
...
Private Sub BoucleDemo(Boucle As Long)
    ...
    For i = 1 To Boucle
        ...
        If cBarre Is Nothing Then Exit For  '// Fermeture du frm démo.
    '// Code ------------------------
        cBarre.UpdateBarre sAvance      '// Affiche l'état d'avancement du scan...
